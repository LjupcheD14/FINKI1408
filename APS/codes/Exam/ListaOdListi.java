...
public class ListaOdListi {
    ...
    public static long findMagicNumber(DLL<DLL<Integer>> list) {
        ...
        long proizvod;
        for (proizvod = 1L; outer != null; outer = outer.succ) {
            long zbir = 0L;

            for (DLLNode<Integer> inner = ((DLL) outer.element).getFirst(); inner != null; inner = inner.succ) {
                zbir += (long) (Integer) inner.element;
            }
            proizvod *= zbir;
        }
        return proizvod;
