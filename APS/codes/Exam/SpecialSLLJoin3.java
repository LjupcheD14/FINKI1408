// 3 elements from first list, then 3 elements from second list
...
public class SpecialSLLJoin<E> {
    ...
    public SLL<E> specialJoin(SLL<E> list1, SLL<E> list2) {
        ...
        while (node1.succ != null & node2.succ != null) {
            ...
            result.insertLast(node1.succ.succ.element);
            result.insertLast(node2.element);
            result.insertLast(node2.succ.element);
            result.insertLast(node2.succ.succ.element);

            node1 = node1.succ.succ.succ;
            node2 = node2.succ.succ.succ;
