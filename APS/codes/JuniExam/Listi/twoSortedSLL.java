// Create a function to merge two sorted singly linked lists into a single sorted list.
...
public class twoSortedSLL {

    public static void func(SLL<Integer> list, SLL<Integer> list2) {
