...
public class DLLVojska {
    ...
    public static DLL<Integer> vojska(DLL<Integer> lista, int a, int b, int c, int d) {
        ...
        //Vasiot kod tuka
        DLLNode<Integer> start1 = lista.find(a), start2 = lista.find(c), end1 = lista.find(b), end2 = lista.find(d);
        DLLNode<Integer> prev1 = start1.pred, prev2 = start2.pred, next1 = end1.succ, next2 = end2.succ;
