...
public class delete_M_nodes_after_N_nodes {

    // Function to skip M nodes and then
    // delete N nodes of the linked list.
    public static void func(SLL<Integer> list1, int n, int m) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Vnesi brisenja N: ");
        int Z = scanner.nextInt();

        System.out.println("Vnesi skokanja M: ");
