// Java program to list into other at k-th position
...
public class listIntoOtherListAtK_thPosition {

    public static void func(SLL<Integer> list1, SLL<Integer> list2, int broj) {
